...
var specialFunctions = _interopRequireWildcard(require("./distribution/special"));

Object.keys(specialFunctions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === specialFunctions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
var linearAlgebraFunctions = _interopRequireWildcard(require("./linearAlgebra"));

Object.keys(linearAlgebraFunctions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === linearAlgebraFunctions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return linearAlgebraFunctions[key];
    }
  });
});

var modelsFunctions = _interopRequireWildcard(require("./models"));

Object.keys(modelsFunctions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === modelsFunctions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return modelsFunctions[key];
    }
  });
});
...
Object.assign(_jStat.jStat, coreFunctions, vectorFunctions, testFunctions, linearAlgebraFunctions, modelsFunctions, specialFunctions); // Generate distribution static methods, i.e. `jStat.gamma(1, 2)`
...
'gammaln gammafn factorial factorialln'.split(' ').forEach(function (passfunc) {
  _jStat.jStat.prototype[passfunc] = function () {
    return (0, _jStat.jStat)(_jStat.jStat.map(this, function (value) {
      return _jStat.jStat[passfunc](value);
    }));
  };
});

_jStat.jStat.prototype.randn = function () {
  return (0, _jStat.jStat)(_jStat.jStat.randn.apply(null, arguments));
}; // Vector functions
...
_jStat.jStat.prototype.oneSidedDifferenceOfProportions = function () {
...
_jStat.jStat.prototype.twoSidedDifferenceOfProportions = function () {
  console.error('Please use jStat.twoSidedDifferenceOfProportions() instead');
}; // Linear algebra


'add divide multiply subtract dot pow exp log abs norm angle'.split(' ').forEach(function (funcName) {
  _jStat.jStat.prototype[funcName] = function (arg, func) {
    var tmpthis = this; // check for callback

    if (func) {
      func.call(tmpthis, _jStat.jStat.prototype[funcName].call(tmpthis, arg));
      return this;
    }

    if (typeof _jStat.jStat[funcName](this, arg) === 'number') return _jStat.jStat[funcName](this, arg);else return (0, _jStat.jStat)(_jStat.jStat[funcName](this, arg));
  };
});
